...
import cn.k8ops.jenkinsci.plugins.asl.util.Constants;
...
public class AslMinioStepRegistryProvider extends StepRegistryProvider {
    ...
    public AslMinioStepRegistryProvider(String endpoint, String credentialsId, String bucket) {
