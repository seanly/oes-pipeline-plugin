...
public class PropertiesLoader implements Serializable {
    ...
    @Nonnull
    public Map<String, String> getVarsFromPropertiesContent(@Nonnull String content, @Nonnull Map<String, String> currentEnvVars) throws AslException {
        if (content == null) {
    ...
    private Map<String, String> getVars(@Nonnull String content, @Nonnull Map<String, String> currentEnvVars)
        ...
        try (StringReader stringReader = new StringReader(escapedContent)) {
            ...
            throw new AslException("Problem occurs on loading content", ioe);
        }
